...
public abstract class PermissionUtils {
    ...
    public static void requestPermission(AppCompatActivity activity, int requestId,
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
            ...
            PermissionUtils.RationaleDialog.newInstance(requestId, finishActivity, permission, message)
    ...
    public static class RationaleDialog extends DialogFragment {
        ...
        private static final String PERMISSION_STR = "permission";
         ...
         *                       cancelled.
         */
        public static RationaleDialog newInstance(int requestCode, boolean finishActivity, String permission, String message) {
            Bundle arguments = new Bundle();
            arguments.putInt(ARGUMENT_PERMISSION_REQUEST_CODE, requestCode);
            arguments.putBoolean(ARGUMENT_FINISH_ACTIVITY, finishActivity);
            arguments.putString(PERMISSION_STR, permission);
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final String permission = arguments.getString(PERMISSION_STR);
